...
class Constants:
    ...
    BOX_OFFICE_PREDICTION_DEFAULT_MODEL_FOLDER: Final[Path] = BOX_OFFICE_PREDICTION_FOLDER.joinpath(f'{BOX_OFFICE_PREDICTION_MODEL_NAME}_1000')
    ...
    BOX_OFFICE_PREDICTION_SETTING_PATH: Final[Path] = BOX_OFFICE_PREDICTION_DEFAULT_MODEL_FOLDER.joinpath('setting.yaml')
